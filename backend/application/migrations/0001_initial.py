# Generated by Django 5.1.1 on 2024-11-11 08:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.user', verbose_name='创建人')),
                ('datasource', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='setting.datasource', verbose_name='数据源')),
                ('model', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='setting.model', verbose_name='模型')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid1, primary_key=True, serialize=False, verbose_name='会话 id')),
                ('user_demand', models.TextField(verbose_name='用户需求')),
                ('chat_content', models.JSONField(blank=True, null=True, verbose_name='会话内容')),
                ('sse_message_list', models.JSONField(blank=True, null=True, verbose_name='sse 消息列表')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application.application', verbose_name='聊天所属应用id')),
            ],
            options={
